...
export interface CategoriaDespesa { id: string; nome: string; cor: string; } // NOVO: Para pintar o gráfico
...
export interface LancamentoFinanceiro { 
  ...
  dataVencimento: string; dataLancamento?: string; status: 'pago' | 'pendente'; 
  categoria: string; fornecedorId?: string; compraId?: string;     
  recorrente?: boolean; grupoRecorrenciaId?: string; 
}